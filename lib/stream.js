...
module.exports = function(url, options) {
	...
	options.got = {retries: 0, ...options.got};
	...
	if (typeof timeout === 'number') {
		timeout = {connect: timeout, socket: timeout, request: timeout};
	} else if (typeof timeout !== 'object') {
		throw new errors.OptionsError('options.timeout must be an object, a number, or null');
	}
	got.timeout = timeout;
